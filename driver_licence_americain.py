...
.col-center { width:36%; min-width:300px; border-radius:10px; padding:14px; }
.col-right { flex:1; border-radius:10px; padding:14px; }

/* Grille interne : 1ère colonne = référence (Sexe) */
.info-grid {
  display:grid;
  grid-template-columns: 150px 1fr; /* largeur fixe de référence */
  gap:8px 18px;
  align-items:start;
}
...
if submit:
    ...
    # Contenu aligné à droite de la référence
    ...
    # Section droite : métadonnées complémentaires
